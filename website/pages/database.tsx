        ...
        <div className="w-4/5 self-center">
            <div className="flex flex-col">
                <div className="flex flex-row space-x-2 space-y-2 self-end flex-wrap mb-4">
                    <button
                        className="py-2 px-4 hover:text-black hover:bg-white transition bg-black border-[1px] border-black text-white rounded-md w-fit h-min self-end"
                        onClick={() => {
                    ...
                    >
                        <div className="flex space-x-2">
                            <IconFileExport strokeWidth="1.25" />
                            <span>Exporter les données</span>
                        </div>
                    </button>
                    <button
                        className="py-2 px-4 hover:text-black hover:bg-white transition bg-black border-[1px] border-black text-white rounded-md w-fit h-min"
                        onClick={clearData}
                    >
                        <div className="flex space-x-2">
                            <IconLoader strokeWidth="1.25" />
                    ...
                    <button onClick={() => {
                        ...
                        <div className="flex space-x-2">
                            {
                                currentAnalyze
                                    ? <IconWreckingBall strokeWidth="1.25" />
